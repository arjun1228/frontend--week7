...
function Products(){
    ...
    return(
      <div className="min-h-screen bg-linear-to-br  py-10 px-6">
        <h1 className="text-4xl font-bold text-center mb-10 text-blue-400 drop-shadow-lg">Product Gallery</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
          {products.map((p, idx) => <Product product={p} key={idx} />)}
        </div>
      </div>
    )
}
